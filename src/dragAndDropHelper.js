    ...
    let DragDropTouch = (function () {
        ...
        function DragDropTouch() {
            ...
            if ('ontouchstart' in document) {
                let d = document, ts = this._touchstart.bind(this), tm = this._touchmove.bind(this), te = this._touchend.bind(this);
        ...
        DragDropTouch.prototype._moveImage = function (e) {
            ...
            requestAnimationFrame(function () {
                ...
                s.zIndex = '999999';
                s.top = s.left = '0px'
                let left = Math.round(pt.x - _this._imgOffset.x);
                let top = Math.round(pt.y - _this._imgOffset.y);
